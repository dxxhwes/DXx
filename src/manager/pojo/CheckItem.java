...
public class CheckItem
{
    ...
    public CheckItem(Integer cid, String ccode, String cname, String refer_val, String unit, Date create_date, Date upd_date, Date delete_date, String option_user, String status) {
        this.cid = cid;
        this.ccode = ccode;
        this.cname = cname;
